...
Severity (1-3) | Problem | Recommendation
------------ | ------------- | -------------
2 | The menu bar has a page titled “DISNEY” (see Fig. 1.1). To someone unfamiliar with the creator’s Disney inspired recipes, this could be confusing as Disney is not usually associated with food and recipes. | Move “DISNEY” to a subcategory under the “RECIPES” page or retitle the page “DISNEY RECIPES” for more clarity.
...
2 | The menu bar is only visible at the top of the webpage and disappears while scrolling. This makes it difficult for users to redirect to a different page if they want to. | Have the menu bar stay at the top of the webpage as the user scrolls down. In addition, there could be a button to close the menu bar if the user does not wish to see it while scrolling.
...
Severity (1-3) | Problem | Recommendation
------------ | ------------- | -------------
1 | The magnifying glass in the search bar is not clickable (see Fig. 1.5). Usually, this symbol is clickable to search on similar websites. | Make the magnifying glass a button to search.
...
Severity (1-3) | Problem | Recommendation
------------ | ------------- | -------------
2 | Although there are subpages for different meals and courses, there is no option to filter for certain ingredients. This lowers the speed at which users can search for a recipe of their liking and also decreases the interaction speed for an expert user. | Create a “filter by” option when searching.
...
1 | This site has two menu bars on the top of the web page (see Fig. 1.1). This is confusing and makes the homepage cluttered. | Choose a few key pages between the two menu bars and combine them into one.
...
Severity (1-3) | Problem | Recommendation
------------ | ------------- | -------------
2 | Although there are subpages for different meals and courses, there is no option to filter for certain ingredients or tools. This lowers the speed 
at which users can search for a recipe of their liking and also decreases the interaction speed for an expert user. | Create a “filter by” option when searching.
